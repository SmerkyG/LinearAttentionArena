...
class CMix_llama(nn.Module):
    def __init__(self, args, layer_id):
        ...
        self.w1 = MyLinear(args.n_embd, self.dim_ffn, bias=False)
        self.w2 = MyLinear(self.dim_ffn, args.n_embd, bias=False)
        self.w3 = MyLinear(args.n_embd, self.dim_ffn, bias=False)
